...
CREATE TABLE `tasks` (
  ...
  `personid` int,
  PRIMARY KEY (`taskid`),
  FOREIGN KEY (personid) REFERENCES projectAccounts(personid)
);
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tasks` (`taskid`, `duedate`, `title`, `description`, `isdone`, `personid`) VALUES
(1, '2017-01-01 00:00:00', 'my title', 'my description', 0, 1),
(2, '2019-05-01 00:00:00', 'my title2', 'my description2', 1, 1),
(3, '2020-06-01 00:00:00', 'my title1', 'my description1', 0, 2),
